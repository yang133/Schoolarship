...
import com.yss.common.annotation.CronTag;
import com.yss.common.service.impl.BaseService;
import com.yss.job.dao.JobMapper;
import com.yss.job.domain.Job;
import com.yss.job.service.JobService;
import com.yss.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.yss.job.task");
